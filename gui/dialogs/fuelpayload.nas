...
var WeightWidget = {
	...
	init : func(instance=me){
		# Calculate CG marker movement
		var x_142 = me._group.getElementById("cg_142").get("coord[0]");
		var x_469 = me._group.getElementById("cg_469").get("coord[0]");
		me._mm_to_px = ( ( x_469 - x_142 ) / 327 );
	...
	_onCGChange : func(n){
		...
		me._cCenterGravityXMarker.setTranslation( (me._cgX-142) * me._mm_to_px, 0);
...
var FuelPayloadClass = {
	...
	openFuel : func(){
		...
		me._widget.Baggage_Left		= PayloadWidget.new(me,me._group,"Baggage_Left", "Left Baggage",2);
		me._widget.Baggage_Right	= PayloadWidget.new(me,me._group,"Baggage_Right", "Right Baggage",3);
		me._widget.Ballast		= BallastWidget.new(me,me._group,"Ballast","Ballast",4);
